...
const Badge = styled.span<{ variant: 'status-todo' | 'status-in_progress' | 'status-done' | 'priority-low' | 'priority-medium' | 'priority-high' }>`
  padding: 4px 12px;
  font-size: 0.75rem;
  font-weight: 600;
...
const Button = styled.button<{ variant: 'view' | 'edit' | 'delete' }>`
  padding: 4px 12px;
  font-size: 0.875rem;
  border-radius: 6px;
  cursor: pointer;
